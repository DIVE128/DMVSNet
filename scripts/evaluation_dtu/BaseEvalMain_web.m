...
% dataPath='<path to datasets>'; %path/Points
dataPath='/data2/yexinyi/datasets/MVS/SampleSet/MVSData';
% plyPath='<path of evaluated ply files>';
plyPath='/data2/yexinyi/code/DMVSNet/outputs_dtu/DMVSNet/pcd';
% resultsPath='<path of evaluating results>';
