...
parser.add_argument('--filter_method', type=str, default='gipuma', choices=["gipuma","pcd_weight", "pcd", "dypcd"], help="filter method")
parser.add_argument('--display', action='store_true', help='display depth images and masks')
parser.add_argument("--winner_take_all_to_generate_depth", action="store_true")
# pcd or dypcd
parser.add_argument('--conf', type=float, nargs='+', default=[0.1, 0.15, 0.7], help='prob confidence, for pcd and dypcd')
parser.add_argument('--thres_view', type=float, default=5, help='threshold of num view, only for pcd')
# dypcd
...
parser.add_argument('--build_stage', type=int, default='3')
